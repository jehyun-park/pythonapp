...
path1.pack(side="left", fill="x",expand=True, ipady=4,padx=5,pady=5)  #ipady : 높이
...
opt_width = ["원본 사이즈","1024","800","640","320"]
...
pvar = DoubleVar()
progress_bar = ttk.Progressbar(progress_frame, maximum=100,variable=pvar)
